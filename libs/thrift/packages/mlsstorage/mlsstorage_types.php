...
include_once $GLOBALS['THRIFT_ROOT'].'/packages/anyval/anyval_types.php';
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'value_',
          'type' => TType::STRUCT,
          'class' => 'Snake\Libs\Thrift\Packages\RowSingle',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          'var' => 'item_',
          'type' => TType::STRUCT,
          'class' => 'Snake\Libs\Thrift\Packages\UniqRowKeyValue',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          'var' => 'item_',
          'type' => TType::STRUCT,
          'class' => 'Snake\Libs\Thrift\Packages\MultiRowKeyValue',
          ),
        );
    }
    if (is_array($vals)) {
