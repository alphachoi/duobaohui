...
Use Snake\Package\Goods\Helper\DBKeywordsBlackListHelper AS DBKeywordsBlackListHelper;

class KeywordsBlackListMapper extends \Snake\Package\Base\Mapper{
    ...
    public function get($sql, $sqlData) {
		$this->keywords = DBKeywordsBlackListHelper::getConn()->read($sql, $sqlData, $this->master, $this->key);
