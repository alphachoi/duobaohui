...
class AttrTwitterCtr1QueryFactory extends \Snake\Package\Base\QueryFactory {

	private $table = "t_seal_attr_twitter_ctr1";
	...
	function newUpdate(DomainObject $obj) { 
        ...
        return $this->buildStatement("t_seal_attr_twitter_ctr1", $values, $cond);
    }   	
}
?>
