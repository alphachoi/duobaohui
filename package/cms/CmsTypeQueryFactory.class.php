...
class CmsTypeQueryFactory extends \Snake\Package\Base\QueryFactory {

	private $table = "t_dolphin_cms_type";
	...
	function newUpdate(DomainObject $obj) { 
        ...
        return $this->buildStatement("t_dolphin_cms_Type", $values, $cond);
    }   	
}
?>
