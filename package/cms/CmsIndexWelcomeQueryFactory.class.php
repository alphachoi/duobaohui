...
class CmsIndexWelcomeQueryFactory extends \Snake\Package\Base\QueryFactory {

	private $table = "t_dolphin_cms_index_welcome";
	...
	function newUpdate(DomainObject $obj) { 
        ...
        return $this->buildStatement("t_dolphin_cms_index_welcome", $values, $cond);
    }   	
}
?>
