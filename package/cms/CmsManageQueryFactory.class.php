...
class CmsManageQueryFactory extends \Snake\Package\Base\QueryFactory {

	private $table = "t_dolphin_cms_manage";
	...
	function newUpdate(DomainObject $obj) { 
        ...
        return $this->buildStatement("t_dolphin_cms_manage", $values, $cond);
    }   	
}
?>
