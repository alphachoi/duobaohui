...
class OAuthSignatureMethod_HMAC_SHA1 extends OAuthSignatureMethod {/*{{{*/
  ...
  public function build_signature($request, $consumer, $token) {/*{{{*/
    ...
    $key_parts = array_map('\Snake\Package\Oauth\OAuthUtil::urlencodeRFC3986', $key_parts);
...
class OAuthRequest {/*{{{*/
  ...
  public function get_signable_parameters() {/*{{{*/
    ...
    $keys = array_map(array('\Snake\Package\Oauth\OAuthUtil', 'urlencodeRFC3986'), array_keys($params));
    $values = array_map(array('\Snake\Package\Oauth\OAuthUtil', 'urlencodeRFC3986'), array_values($params));
  ...
  public function get_signature_base_string() {/*{{{*/
	...
	//print_r($parts);
    $parts = array_map(array('\Snake\Package\Oauth\OAuthUtil','urlencodeRFC3986'), $parts);
