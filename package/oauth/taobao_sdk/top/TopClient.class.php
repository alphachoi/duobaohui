<?php
namespace Snake\Package\Oauth\Taobao_sdk\Top;

use \Snake\Package\Oauth\Taobao_sdk\Top\Request\UserBuyerGetRequest;
...
class TopClient
{
	...
	protected function curl($url, $postFields = null, $fromMobile = FALSE)
	{
		...
		else
		{
			...
			{
				$logHandle = new SnakeLog('taobaoAuth', 'normal');
	...
	public function execute($request, $session = null)
	{
		...
		{
			$logHandle = new \Snake\Libs\Base\SnakeLog($this->errorLogFileName, "normal");
