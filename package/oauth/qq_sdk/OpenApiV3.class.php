...
Use \Snake\Package\Oauth\Qq_sdk\Lib\SnsNetwork;
Use \Snake\Package\Oauth\Qq_sdk\Lib\SnsSigCheck;
Use \Snake\Package\Oauth\Qq_sdk\Lib\SnsStat;
...
class OpenApiV3
{
	...
	public function api($script_name, $params, $method='post', $protocol='http')
	{
		...
		$logHelper = new \Snake\Libs\Base\SnakeLog('qzoneApiUrl', 'normal');
