<?php
namespace Snake\Package\Oauth\Baidu_pcs;

Use \Snake\Package\Oauth\Baidu_pcs\RequestCore;
Use \Snake\Package\Oauth\Baidu_pcs\ResponseCore;
/***************************************************************************
 * 
...
class BaiduPCS {
    ...
    public function __construct($auth) {
        ...
        if ((!isset($auth['access_token']) || empty($auth['access_token'])) &&
			...
			$logHandle = new \Snake\Libs\Base\SnakeLog('baidu_pcs', 'normal');
