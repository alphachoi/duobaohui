 ...
 * @since 2012.08.03
 */
class SearchBusinessExpr extends SearchExpr{
	...
	public function getExpr() {
		...
		return "$busModulus * pow( IF(commission == 1, 1, 0.35) * IF( sale_volume > 144, 1, 0.1 + pow( sale_volume, 1/2) / 12 * 0.9) * IF( level > 8, 1, 0.5), 1/3) ";
	}
