...
class TwitterNote implements \Snake\Libs\Interfaces\Iobservable {
...
//	const twitterSourceUid = 0;
	...
	public function __construct($uid, $source, $ip) {
	...
	public function createNoteTwitter() {
	...
	private function trigger() {
		foreach ($this->observers as $object) {
			$object->onChanged("twitterNote", array($this->tInfo));
		}
		return TRUE;
	}
...
//		$this->tInfo['twitter_reply_show'] = $this->twitterReplyShow;
		...
		$this->tInfo['twitter_images_id'] = 0;  
