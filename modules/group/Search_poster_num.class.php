...
class Search_poster_num extends \Snake\Libs\Controller {
    private $searchKey = '';
    private $frame = 0;
    private $page = 0;
    private $offset = 0;
    ...
    public function run() {
		...
		$offset = ($this->page * $this->frame + $this->frame) * self::pageSize;
		$result = $searchHelper->handleSearchGroup($this->searchKey, $this->userId, $offset, self::pageSize, 1);
		$this->view = $result;
		return TRUE;
	}
